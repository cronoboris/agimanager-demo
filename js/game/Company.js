...
import { CompetitorSimulationSystem, canSubscribeToCompetitorModel, getCompetitorSubscriptionPricing } from './CompetitorSimulationSystem.js';

export { canSubscribeToCompetitorModel, getCompetitorSubscriptionPricing } from './CompetitorSimulationSystem.js';

export class CompanySystem {
    constructor(gameState) {
        this.state = gameState;
        this.competitorSimulation = new CompetitorSimulationSystem(this.state);
        this.initCompetitors();
    }

    initCompetitors() {
        return this.competitorSimulation.initCompetitors();
    }

    processMonthly() {
        return this.competitorSimulation.processMonthly();
    }

    processHourly(hours = 1) {
        return this.competitorSimulation.processHourly(hours);
    }

    processSixHourly(hours = 6) {
        return this.competitorSimulation.processSixHourly(hours);
    }
    ...
    _releaseModel(comp) {
        ...
        const performance = Math.min(B.PERFORMANCE_CAP, comp.aiLevel * 1.065 + Math.random() * 4);
